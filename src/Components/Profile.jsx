...
const Profile = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 items-center justify-center min-h-screen bg-violet-400 px-4">
      <Helmet>
      ...
      <div className="backdrop-blur-md bg-white/10 border border-white/30 shadow-2xl rounded-2xl p-6 w-full max-w-md text-center text-white">
        <img
          src={photoURL}
          alt="Profile"
          className="w-32 h-32 mx-auto rounded-full object-cover mb-4 border-4 border-violet-600"
        />
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-violet-700 hover:bg-violet-700 text-white py-2 rounded-md transition"
        >
          Update Profile
        </button>
      </form>
